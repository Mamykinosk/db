...
/*
CREATE TABLESPACE ozon_data_space LOCATION '/Library/PostgreSQL/17/data/ozon_data';
CREATE TABLESPACE ozon_idx_space LOCATION '/Library/PostgreSQL/17/data/ozon_indexes';
*/
...
-- User profiles (1-to-1 relationship)
...
-- User addresses (1-to-many relationship)
...
-- Categories (self-referencing for parent categories)
...
-- Payments (note: typo "payements" from your original)
